...
insights, built as a portfolio project. This doc holds the visual walkthrough —
drop screenshots and a demo GIF into `docs/` using the paths below and they'll
render here and on GitHub.
